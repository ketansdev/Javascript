...
// // const ans = employees.map((employee) => ({name: employee.name, age: employee.age}));
// // console.log(ans);

// const total_salary = employees.reduce((accumulator, currentValue) => {
//   if (currentValue.active) return accumulator + currentValue.salary;
...
let arr = [20, 40, 10, 20, 45, 67, 32, 45];
